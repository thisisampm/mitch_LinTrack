function [bin_rates, bin_rates_norm, trl_bin_rates, spike_counts] = rate_xdim_dir(datamtx, clusters, varargin)
%plots rate over the xdim of the maze
%flips odd trials to reveal directional firing (symmetrical spatial code)
...
for itrl = 1:num_trials
    ...
    if rem(itrl,2) == 0
        ...
        trl_bin_rates = cat(3, trl_bin_rates, fliplr(spike_pos_binned./dwell_pos_binned));
    end
