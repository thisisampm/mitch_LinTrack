function [cor_mtx_all, ebp_reference_all, ebp_adjacent_all] = sesh_to_sesh_corrs_multi(subj_cell, reference_session)
...
ebp_reference_means = nan(length(subj_cell), 7);
ebp_adjacent_means = nan(length(subj_cell), 7);
ebp_reference_all = cell(length(subj_cell), 7);
ebp_adjacent_all = cell(length(subj_cell), 7);
