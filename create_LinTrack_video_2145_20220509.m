...
folder_path = 'C:\Users\mitch\OneDrive - University of Toronto\PhD\Experiments\LinearTrack\Raw_track_data\exercise\214-5\2022-03-15';

Ca_vid_path = fullfile(folder_path, '2022-03-15-11-44-16.mkv');
cnmfe_path = fullfile(folder_path, '214-5_2022-03-15-11-44-16_cnmfe.mat');
pos_vid_path = fullfile(folder_path, '2022_03_15_11_44_14_behaviour.avi');
...
behav_ts_path = fullfile(folder_path, '2022_03_15_11_44_14_ts_dlc_time.csv');
Ca_ts_path = fullfile(folder_path, '2022-03-15-11-44-16_Ca_time.csv');

behav_ts = readmatrix(behav_ts_path);
ca_ts = readmatrix(Ca_ts_path);
